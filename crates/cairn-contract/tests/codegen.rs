...
use cairn_contract::{
    AnswerEvent, AskRequest, Command, CommandResponse, ContractError, Event, GraphEdge, GraphNode,
    GraphScope, NoteSummary, Query, QueryResponse, SuggestedEdge, TagCount,
};
use ts_rs::TS;
...
fn exports_typescript_bindings() {
    ...
    assert!(SuggestedEdge::decl().contains("SuggestedEdge"));
    ...
    SuggestedEdge::export_all().unwrap();
}
